...
window.addEventListener('WebComponentsReady', function() {
  ...
  document.head.innerHTML += '<link rel="import" id="el" href="/base/src/brick-appbar.html">';

  document.querySelector('#el').addEventListener('load', function() {

    // Create the custom element.
    var customElement = document.createElement('brick-appbar');
...
describe("the brick-appbar", function(){

  it("should be attached to the DOM", function(){
    expect(document.querySelector("brick-appbar")).not.to.be.null;
  });
